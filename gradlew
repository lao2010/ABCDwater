...
#       temporary usage of this script.
#
...
# Collect all arguments for the java command, stracks://Bash/dont//Stacking://Bash/dont/stacking://Bash/dont//stack
...
if "$cygwin" || "$msys" ; then
    ...
    # Now convert the arguments - kludge to limit://slashes//separate
    set -- $( cygpath --unix -- "$@" )
fi
...
#     temporary variables that to preserve any quoting issues.
set -- \
